"""
Django settings for ModulPQRS project.
...
SECRET_KEY = 'django-insecure-5et3$mz%1(d(d=!8c5^@9u2ke1%8k^73y-7$tc%j$gfdf8h22('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = ['192.168.0.162','177.234.200.10']
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'ModulPQRS.wsgi.application'
...
#         'NAME': 'railway',
#         'USER': 'postgres',
#         'PASSWORD': 'dYelFoHTFpIWJlNsckTtwHXtoNSflrjq',
...
# Para subir archivos importando os
MEDIA_URL='/media/'
